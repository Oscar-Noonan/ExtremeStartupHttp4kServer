...
class ExtremeStartupHttp4kServerTest {
    ...
    @Test
    fun canAnswerMyName() {
        assertThat(app(Request(GET, "?q=What+is+your+name%3F")), equalTo(Response(OK).body("oscar")))
    }
    ...
    fun `canAnswerMyName using real running service`() {
        ...
        assertThat(httpClient(Request(GET, "http://localhost:8124?q=What+is+your+name%3F")), hasBody("oscar"))
    }
